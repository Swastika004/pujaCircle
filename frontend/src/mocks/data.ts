...
export const SEED_PUJA_CATALOG: PujaCatalogEntry[] = [
  {
    ...
    timingNote: 'Best performed during Shukla Paksha morning muhurat according to devotee Janma Rashi.',
    category: 'life-event',
  },
  {
  ...
  },
  {
    ...
    steps: ['Navagraha Mandal design with nine sacred grains', 'Sankalp detailing Janma Nakshatra and troubled dasha period', 'Individual Beej Mantra chanting for each of the nine grahas', 'Navagraha Havan with corresponding medicinal wood', 'Daan sankalp and Shanti Paath'],
  ...
  },
  {
    ...
    timingNote: 'Ideal during Shukla Paksha Friday or Pushya Nakshatra day.',
    category: 'business',
  },
  {
    ...
    timingNote: 'Perform precisely on the lunar tithi of the departed ancestor during Aparahna (afternoon).',
    category: 'ancestral',
  },
  {
    ...
    timingNote: 'Determined through Kundali matching and auspicious Vivah Muhurat.',
    category: 'life-event',
  },
  {
  ...
  {
    id: 'catalog-namkaran',
    name: 'Shishu Namkaran & Janma Nakshatra Pujan',
    deity: 'Kula Devata & Janma Nakshatra Adhipati',
    description: 'Vedic baby naming ceremony aligning the child name vibration with their astrological birth syllable and gotra lineage.',
    ...
    steps: ['Sankalp for child vitality and fame', 'Janma Nakshatra Devata pujan', 'Father whispers auspicious Vedic name in infant right ear', 'Writing baby name upon raw rice bed with golden stylus', 'Blessings from matriarchs and paternal elders'],
    timingNote: '11th, 12th, or 21st day after childbirth on an auspicious nakshatra.',
    category: 'life-event',
  },
  {
  ...
  },
  {
    ...
    timingNote: 'Shukla Paksha Monday or Thursday on an auspicious Vastu Muhurat.',
    category: 'business',
  },
  {
  ...
  },
  {
    ...
    steps: ['Sankalp naming gotra and three generations of ancestors', 'Vishnu Pada contemplation and Tarpana', 'Pinda Pradana with dedicated Vedic Suktas', 'Kusha visarjan and prayer for soul salvation', 'Final charity offering in name of ancestors'],
  ...
  },
  {
    ...
    timingNote: 'Janmashtami midnight during Rohini Nakshatra.',
    category: 'festival',
  },
  {
  ...
  },
  {
    ...
    description: 'Vedic ritual resolving Jupiter-Rahu conjunctions in horoscope that cause questionable decisions, professional setbacks, and loss of respect.',
  ...
  },
  {
    ...
    timingNote: 'Shukla Paksha Thursday or Rohini Nakshatra morning.',
    category: 'life-event',
  },
  {
    ...
    timingNote: 'Exact birth month and tithi of completing 60 years of age.',
    category: 'life-event',
  },
  {
